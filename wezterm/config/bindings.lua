...
local keys = {
   ...
   { key = 'F4', mods = 'NONE', action = act.ShowLauncherArgs({ flags = 'FUZZY|LAUNCH_MENU_ITEMS'}) },
   ...
   -- panes: scroll pane
   { key = 'k',        mods = mod.SUPER, action = act.ScrollByLine(-5) },
   { key = 'j',        mods = mod.SUPER, action = act.ScrollByLine(5) },
